...
namespace COLIBRIVR.Processing
{
    ...
    /// </summary>
    public class AsyncDepthTextureArray : AsyncProcessingMethod
    {
...
#region INHERITANCE_METHODS
        ...
        public override void InitializeLinks()
        {
            ...
            _nestedMethodsToDisplay = new AsyncProcessingMethod[] { PMPerViewMeshesQSTRDTA };
        }
...
#region METHODS
        ...
        public IEnumerator LoadDepthTextureArrayCoroutine()
        {
            ...
            var bundledAssetName = bundledAssetsPrefix + depthMapsAssetName;
            yield return dataHandler.StartCoroutine(dataHandler.LoadAssetsFromBundleFromUrlCoroutine<Texture2DArray>(processingCaller.renderingCaller.url, (result => depthData = result[0]), bundledAssetName));
        }
