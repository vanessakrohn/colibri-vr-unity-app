...
namespace COLIBRIVR.Processing
{
    ...
    /// </summary>
    public abstract class AsyncProcessingMethod : AsyncMethod, IMethodGUI
    {
...
#region STATIC_PROPERTIES
        ...
        public static System.Type[] PMTypes
        {
            get
            {
                ...
                {
                    typeof(AsyncProcessingMethodTemplate),
                    typeof(AsyncColorTextureArray),
                    typeof(AsyncPerViewMeshesFS),
                    typeof(AsyncPerViewMeshesQSTR),
                    typeof(AsyncGlobalMeshEF),
                    typeof(AsyncDepthTextureArray),
                    typeof(AsyncGlobalTextureMap),
                    typeof(AsyncPerViewMeshesQSTRDTA)
                };
            }
        }
...
#region STATIC_METHODS
        ...
        public static AsyncProcessingMethod[] CreateOrResetProcessingMethods(Transform parentTransform)
        {
            AsyncProcessingMethod[] methods = GeneralToolkit.GetOrCreateChildComponentGroup<AsyncProcessingMethod>(PMTypes, PMTransformName, parentTransform);
...
#region FIELDS
        ...
        [SerializeField] protected AsyncProcessingMethod[] _nestedMethodsToDisplay;
...
#region METHODS
        ...
        public IEnumerator ExecuteAndWaitForMemoryRelease(IEnumerator executeCoroutine)
        {
            ...
            GeneralToolkit.UpdateCancelableProgressBar(typeof(AsyncProcessingMethod), true, false, false, 2, progressBarTitle, progressBarInfo, exitMessage);
