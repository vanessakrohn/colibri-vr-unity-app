...
namespace COLIBRIVR.Processing
{
    ...
    /// </summary>
    public class AsyncColorTextureArray : AsyncProcessingMethod
    {
...
#region METHODS
        ...
        public IEnumerator LoadProcessedTextureArrayCoroutine()
        {
            ...
            var bundledAssetName = bundledAssetsPrefix + colorDataAssetName;
            yield return dataHandler.StartCoroutine(dataHandler.LoadAssetsFromBundleFromUrlCoroutine<Texture2DArray>(processingCaller.renderingCaller.url, (result => colorData = result[0]), bundledAssetName));
        }
