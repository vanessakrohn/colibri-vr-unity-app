...
namespace COLIBRIVR.Processing
{
    ...
    /// </summary>
    public class AsyncGlobalMeshEF : AsyncProcessingMethod
    {
...
#region INHERITANCE_METHODS
        ...
        public override void InitializeLinks()
        {
            ...
            _nestedMethodsToDisplay = new AsyncProcessingMethod[] { PMDepthTextureArray, PMGlobalTextureMap };
        }
...
#region METHODS
        ...
        public IEnumerator LoadProcessedGlobalMeshCoroutine()
        {
            ...
            var bundledAssetName = bundledAssetsPrefix + globalMeshAssetName;
            yield return dataHandler.StartCoroutine(dataHandler.LoadAssetsFromBundleFromUrlCoroutine<Mesh>(processingCaller.renderingCaller.url, (result => globalMesh = result[0]), bundledAssetName));
