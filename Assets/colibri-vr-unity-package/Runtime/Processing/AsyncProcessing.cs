...
namespace COLIBRIVR.Processing
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    public class AsyncProcessing : MonoBehaviour
    {
...
#region PROPERTIES
        ...
        public AsyncProcessingMethod[] processingMethods { get { return _processingMethods; } }
...
#region FIELDS
        ...
        [SerializeField] private AsyncProcessingMethod[] _processingMethods;
        [SerializeField] private AsyncColorTextureArray _previewSourceImagesLoader;
...
#region INHERITANCE_METHODS
        ...
        public void Reset()
        {
            ...
            renderingCaller = GetComponent<Rendering.AsyncRendering>();
            ...
            _processingMethods = AsyncProcessingMethod.CreateOrResetProcessingMethods(transform);
        ...
        void OnDestroy()
        {
            if(!GeneralToolkit.IsStartingNewScene())
            {
                ...
                GeneralToolkit.RemoveChildren(transform, ExternalHelper.EHTransformName, AsyncProcessingMethod.PMTransformName,
                    AsyncRenderingMethod.RMTransformName, EvaluationMethod.EMTransformName);
            }
        }
...
#region METHODS
        ...
        private IEnumerator ProcessDataCoroutine()
        {
            ...
            Debug.Log(GeneralToolkit.FormatScriptMessage(typeof(AsyncProcessing), "Started processing data."));
            ...
            {
                AsyncProcessingMethod processingMethod = processingMethods[iter];
            ...
            if(!processingCanceled)
                Debug.Log(GeneralToolkit.FormatScriptMessage(typeof(AsyncProcessing), "Finished processing data."));
            else
                Debug.Log(GeneralToolkit.FormatScriptMessage(typeof(AsyncProcessing), "Processing was canceled."));
        ...
        public void DisplayAndUpdateCancelableProgressBar(string progressBarTitle, string progressBarInfo)
        {
            ...
            GeneralToolkit.UpdateCancelableProgressBar(typeof(AsyncProcessing), true, true, true, progressBarMaxIter, progressBarTitle, progressBarInfo, exitMessage);
        }
