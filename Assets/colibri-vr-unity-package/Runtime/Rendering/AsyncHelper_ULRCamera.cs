...
namespace COLIBRIVR.Rendering
{
    ...
    /// </summary>
    public class AsyncHelper_ULRCamera : MonoBehaviour
    {
...
#region FIELDS
        ...
        private List<AsyncHelper_ULR> _helperULRList;
...
#region METHODS
        ...
        private void Initialize()
        {
            ...
            {
                _helperULRList = new List<AsyncHelper_ULR>();
        ...
        public void AddRenderedObject(AsyncHelper_ULR helperULR, int totalVertexCount)
        {
            if(!_initialized)
                Initialize();
            if(_initialized)
        ...
        public void UpdateValuesOnPreRender()
        {
            ...
            while(renderedObjIndex < _helperULRList.Count)
            {
                ...
                AsyncHelper_ULR helperULR = _helperULRList[renderedObjIndex];
                if(helperULR == null)
                {
