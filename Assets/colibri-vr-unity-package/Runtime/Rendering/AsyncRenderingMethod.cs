...
namespace COLIBRIVR.Rendering
{
    ...
    /// </summary>
    public abstract class AsyncRenderingMethod : AsyncMethod, IMethodGUI
    {
...
#region STATIC_PROPERTIES
        ...
        public static System.Type[] RMTypes
        {
            get
            {
                ...
                {
                    typeof(AsyncRenderingMethodTemplate),
...
#region STATIC_METHODS
        ...
        public static AsyncRenderingMethod[] GetCompatibleRenderingMethods(AsyncRendering caller)
        {
            List<AsyncRenderingMethod> compatibleMethods = new List<AsyncRenderingMethod>();

            foreach(AsyncRenderingMethod method in caller.renderingMethods)
        ...
        public static AsyncRenderingMethod[] CreateOrResetRenderingMethods(Transform parentTransform)
        {
            AsyncRenderingMethod[] methods = GeneralToolkit.GetOrCreateChildComponentGroup<AsyncRenderingMethod>(RMTypes, RMTransformName, parentTransform);
...
#region FIELDS
        ...
        public AsyncProcessingMethod[] sceneRepresentationMethods;
