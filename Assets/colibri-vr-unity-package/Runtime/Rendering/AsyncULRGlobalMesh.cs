...
namespace COLIBRIVR.Rendering
{
    ...
    /// </summary>
    public class AsyncULRGlobalMesh : AsyncRenderingMethod
    {

#region FIELDS

        [SerializeField] public AsyncHelper_ULR _helperULR;
...
#region INHERITANCE_METHODS
        ...
        public override void Reset()
        {
            ...
            _helperULR = GeneralToolkit.GetOrAddComponent<AsyncHelper_ULR>(gameObject);
            _helperULR.Reset();
        }
