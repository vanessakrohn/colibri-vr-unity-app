...
namespace COLIBRIVR.Processing
{
    ...
    /// </summary>
    [CustomEditor(typeof(AsyncProcessing))]
    public class AsyncProcessingEditor : Editor
    {
...
#region STATIC_METHODS        
        ...
        public static void SectionDataDirectory(AsyncProcessing targetObject)
        {
...
#region FIELDS
        ...
        private AsyncProcessing _targetObject;
...
#region INHERITANCE_METHODS
        ...
        void OnEnable()
        {
            ...
            _targetObject = (AsyncProcessing)serializedObject.targetObject;
...
#region METHODS
        ...
        private void SectionProcessingMethods()
        {
            ...
            AsyncProcessingMethod[] allMethods = _targetObject.processingMethods;
            List<AsyncProcessingMethod> topmostMethods = new List<AsyncProcessingMethod>();
