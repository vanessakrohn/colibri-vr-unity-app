...
namespace COLIBRIVR.DatasetHelpers
{
    ...
    /// </summary>
    [CustomEditor(typeof(_3DScannerAppHelper))]
    public class _3DScannerAppHelperEditor : Editor
    {

#region FIELDS

        private _3DScannerAppHelper _targetObject;
...
#region INHERITANCE_METHODS
        ...
        void OnEnable()
        {
            _targetObject = (_3DScannerAppHelper)serializedObject.targetObject;
            // Get the target properties.
            _propertyScaleFactor = serializedObject.FindProperty(_3DScannerAppHelper.propertyNameScaleFactor);
            _propertyRepositionAroundCenter = serializedObject.FindProperty(_3DScannerAppHelper.propertyNameRepositionAroundCenter);
        }
